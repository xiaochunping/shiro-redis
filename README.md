...
* use `git clone https://github.com/xiaochunping/shiro-redis.git` to clone project to your local workspace and build jar file by your self
...
Here is a [tutorial project](https://github.com/xiaochunping/shiro-redis-tutorial) for you to understand how to configure `shiro-redis` in `shiro.ini`.
...
<!-- Redis Manager [start] -->
<bean id="redisManager" class="com.xiaochunping.shiro.RedisManager">
    <property name="host" value="127.0.0.1:6379"/>
</bean>
        <!-- Redis Manager [end] -->

        <!-- Redis session DAO [start] -->
<bean id="redisSessionDAO" class="com.xiaochunping.shiro.RedisSessionDAO">
...
<property name="sessionDAO" ref="redisSessionDAO"/>
        ...
        <!-- Redis cache manager [start] -->
<bean id="cacheManager" class="com.xiaochunping.shiro.RedisCacheManager">
<property name="redisManager" ref="redisManager"/>
</bean>
        <!-- Redis cache manager [end] -->
...
Here is a [tutorial project](https://github.com/xiaochunping/shiro-redis-spring-tutorial) for you to understand how to configure `shiro-redis` in spring configuration file.
...
<!-- shiro-redis configuration [start] -->
<!-- shiro redisManager -->
<bean id="redisManager" class="com.xiaochunping.shiro.RedisSentinelManager">
...
<!-- shiro-redis configuration [start] -->
<!-- shiro redisManager -->
<bean id="redisManager" class="com.xiaochunping.shiro.RedisClusterManager">
    <property name="host"
...
You can use your own custom serializer, as long as this custom serializer implements `RedisSerializer`
...
#
# cacheManagerKeySerializer = StringSerializer
...
For full example, see [shiro-redis-spring-boot-tutorial](https://github.com/xiaochunping/shiro-redis-spring-boot-tutorial)
